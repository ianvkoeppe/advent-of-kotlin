...
class Day12Tests {
  @Test
  fun partOneExamples() {
    assertThat(Day12.partOne(Reader.read("src/test/resources/day12/example.txt"))).isEqualTo(10)
  ...
  @Test
  fun partTwoExample() {
    assertThat(Day12.partTwo(Reader.read("src/test/resources/day12/example.txt"))).isEqualTo(36)
