...
class Day16Tests {
  ...
  @Test
  fun partOne() {
    assertThat(Day16.partOne(Reader.read("src/test/resources/day16/problem.txt"))).isEqualTo(999)
  }
  ...
  @Test
  fun partTwo() {
    assertThat(Day16.partTwo(Reader.read("src/test/resources/day16/problem.txt"))).isEqualTo(3408662834145)
  }
}