...
object Day12 {
  ...
  private fun countPaths(paths: Map<String, List<String>>, maxSingleSmallCaveVisits: Int, current: String, previouslyVisitedCaves: Map<String, Int> = mapOf(), acc: MutableMap<Pair<String, String>, Int> = mutableMapOf()): Int {
